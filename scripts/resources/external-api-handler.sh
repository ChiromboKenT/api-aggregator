...
aws --endpoint-url=${LOCALSTACK} sns set-subscription-attributes --subscription-arn ${SUBSCRIPTION_ARN} --attribute-name FilterPolicy --attribute-value "{\"EVENT\":[\"AGGREGATOR_TRIGGERED\"]}"
